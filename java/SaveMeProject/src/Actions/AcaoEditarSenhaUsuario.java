...
@WebServlet("/AcaoEditarSenhaUsuario")
public class AcaoEditarSenhaUsuario extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(usuario.update()){
			...
			request.setAttribute("me", "Erro na troca de senha! Por favor, tente novamente mais tarde.");
